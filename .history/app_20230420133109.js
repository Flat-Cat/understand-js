    ...
    for (var i = 0; i < 3; i++) {
        ...
        arr.push (
            ...
            function(j) {
              ...
              //Stattdessen wird der gleiche Kontext beibehalten, und die Schleife wird erneut durchlaufen, bis die Bedingung nicht mehr erfüllt ist und das Array zurückgegeben wird.
                }
            }(i))   
    }
    return arr;
